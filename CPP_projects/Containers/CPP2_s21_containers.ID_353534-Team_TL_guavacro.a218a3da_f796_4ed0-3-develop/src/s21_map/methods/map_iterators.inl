...
inline typename s21::map<Key, T, Compare>::const_reference
s21::map<Key, T, Compare>::mapIterator::operator*() const {
...
inline typename s21::map<Key, T, Compare>::mapIterator&
s21::map<Key, T, Compare>::mapIterator::operator++() {
...
inline typename s21::map<Key, T, Compare>::mapIterator
s21::map<Key, T, Compare>::mapIterator::operator++(int) {
...
inline bool s21::map<Key, T, Compare>::mapIterator::operator==(
...
inline typename s21::map<Key, T, Compare>::const_reference
s21::map<Key, T, Compare>::mapConstIterator::operator*() const {
  return current_node->value;
}

template <typename Key, typename T, typename Compare>

bool s21::map<Key, T, Compare>::mapConstIterator::operator==(
...
s21::map<Key, T, Compare>::mapIterator::find_next(Node* node) {
...
inline typename s21::map<Key, T, Compare>::Node*
s21::map<Key, T, Compare>::mapIterator::find_previous(Node* node) {
