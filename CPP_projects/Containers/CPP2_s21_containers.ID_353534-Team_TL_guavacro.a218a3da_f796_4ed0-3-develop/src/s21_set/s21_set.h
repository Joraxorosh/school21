...
class set {
 ...
 public:
  ...
  class setIterator {
   ...
   public:
    setIterator(Node* node = Node::nil()) : current_node(node) {}

    set::const_reference operator*() const;
  ...
  class setConstIterator {
   ...
   public:
    setConstIterator(Node* node = Node::nil()) : current_node(node) {}
  ...
  std::pair<set::iterator, bool> insert(
