...
inline void s21::set<Key, Compare>::erase(iterator pos) {
...
inline void s21::set<Key, Compare>::node_transplant(Node* old_node,
                                                    Node* new_node) {
...
inline typename s21::set<Key, Compare>::Node* s21::set<Key, Compare>::minimum(
    Node* node) {
...
void s21::set<Key, Compare>::fix_delete_violations(Node* new_node) {
